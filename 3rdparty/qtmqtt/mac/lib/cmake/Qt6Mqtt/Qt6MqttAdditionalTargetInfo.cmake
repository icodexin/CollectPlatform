...
get_target_property(_qt_imported_link_dependencies Qt6::Mqtt IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE)
...
if(_qt_imported_link_dependencies)
    set_property(TARGET Qt6::Mqtt PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES_RELWITHDEBINFO "${_qt_imported_link_dependencies}")
endif()
...
if(_qt_imported_link_dependencies)
    set_property(TARGET Qt6::Mqtt PROPERTY IMPORTED_LINK_DEPENDENT_LIBRARIES_MINSIZEREL "${_qt_imported_link_dependencies}")
endif()
